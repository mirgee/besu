...
public class LayeredKeyValueStorageTest {
  ...
  void shouldReturnValuesForMultipleKeysAcrossSegments() {
    ...
    ConcurrentMap<SegmentIdentifier, NavigableMap<Bytes, Optional<byte[]>>> layerMap = new ConcurrentHashMap<>();
    ...
    List<byte[]> result = layeredKeyValueStorage.multiget(
        List.of(segmentA, segmentB, segmentA),
