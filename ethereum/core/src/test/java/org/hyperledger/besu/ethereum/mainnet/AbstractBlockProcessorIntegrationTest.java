...
class AbstractBlockProcessorIntegrationTest {
  ...
  void blockAccessListStateRootMatchesAccumulatorForSimpleTransfers(
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x3e8b87ab7514a58f5d6ea04bbd5e234075f3dfa69daf4b35a70c2521f8419bd0",
            Wei.of(5),
  ...
  void blockAccessListStateRootMatchesAccumulatorForStorageAndReads(
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x9329e6a0f778981915b537bed75c3771e69b2672e93beaf2ac439cfdd4d8e3bb",
            Wei.of(5),
            setSlot1Transaction,
            getSlot1Transaction,
            setSlot3Transaction,
  ...
  void testProcessBlockZeroReward() {
    ...
    Block block =
        createBlockWithTransactions(
            "0x543c14cacf1fb32ea5cc62d0fcae0babf9b63c50bbc83531ca9c0f9326ca66a5",
            Wei.ZERO,
            transactions);
  ...
  private void processSimpleTransfers(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0xcf3d10e981386e78dc7d560bc881b97d9b8031f52c92c3e63159e816754be71d",
            Wei.of(5),
            transactionTransfer1,
            transactionTransfer2);
  ...
  private void processConflictedSimpleTransfersSameSender(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0xa4ccbd55b66fad4a390eef577cc4e66ce3b5510e0f234035362af65d169a22fd",
            Wei.of(5),
  ...
  private void processConflictedSimpleTransfersSameAddressReceiverAndSender(
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x10198e601dc2b307c10964632b1c28c19a328ff83750d93d6b49158c4c138cfb",
            Wei.of(5),
            transferTransaction1,
            transferTransaction2);
  ...
  private void processConflictedSimpleTransfersWithCoinbase(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x4e12d3c343b4a0acd51df116b9ec2acbc26776c920ab9a7dde3857b49842521e",
            Wei.of(5),
            transferTransaction1,
            transferTransaction2);
  ...
  void processContractSlotUpdateThenReadTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x4b983f0f5d988933add79cdff89810133cb0bf04815af70d0856262394b7b241",
            Wei.of(5),
            setSlot1Transaction,
            getSlot1Transaction,
            setSlot3Transaction,
  ...
  void processSlotReadThenUpdateTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0xede3ade152c7a5996031bf8bb484a87aca30bc8b2e6345056c675dbc0ccfe804",
            Wei.of(5),
            getSlot1Transaction,
            setSlot1Transaction,
            setSlo2Transaction,
  ...
  void processAccountReadThenUpdateTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0xb7377e63f63d44b5069dc4d8ea0a770319c6377b105067c35c5ed69175b88457",
            Wei.of(5),
            transactionTransfer,
  ...
  void processAccountUpdateThenReadTx(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x5b89484a6aaf8d027094022f0efe11d7da7f719061bd5899399f46b3bcd96295",
            Wei.of(5),
            transactionTransfer,
            sendEthFromContractTransaction,
            getcontractBalanceTransaction);
  ...
  void processAccountReadThenUpdateTxWithTwoAccounts(final BlockProcessor blockProcessor) {
    ...
    Block blockWithTransactions =
        createBlockWithTransactions(
            "0x6293e99f3e19ed398f5597224134fbd3d45473fa643eea500cb2483a76ac4473",
            Wei.of(5),
            transactionTransfer,
            getcontractBalanceTransaction,
            sendEthFromContractTransaction);
